    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#138E29">
        ...
        <div class="navbar-collapse collapse w-100 dual-collapse2 order-1 order-md-0">
            <ul class="navbar-nav mx-auto text-center">
                <li class="nav-item"><a class="nav-link" href="/home">Články</a></li>
                ...
                <li class="nav-item"><a href="{{ route('logout') }}" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Odhlášení</a></li>
